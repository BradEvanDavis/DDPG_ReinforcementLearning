...
def ddpg(n_episodes=300, max_t=1000, train=True, num_agents=20, print_every=1, train_mode=True):
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        if i_episode % print_every == 0:
            print('\rEpisode {}, Mean last 100: {:.2f}, Mean current: {:.2f}, Max: {:.2f}, Min: {:.2f}, Time: {:.2f}'\
                .format(i_episode, moving_avgs[-1], mean_scores[-1], max_scores[-1], min_scores[-1], round(duration/60,2), end="\n"))
